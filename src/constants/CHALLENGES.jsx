...
export const CHALLENGES = [
	...
	},
	{
		title: 'Passcode',
		description:
			'A component which simulates a phone lock screen. Each attempt is checked against the actual passcode given through props, and the result is rendered accordingly.',
		thumbnail: passcodeThumbnail,
		thumbnailAlt: 'passcode',
